...
export default class Deposit extends Component {
  ...
  submitDeposit(event) {
    ...
    axios.get("http://localhost:8080/depositmoney", { params: deposit }, {
      headers: {
    ...
    return (
      <div className="login-container">
        <Card className={"border border-dark bg-dark text-white"}>
          <Card.Header className="custom-card-header">Deposit Form</Card.Header>
          <Form onSubmit={this.submitDeposit} className="custom-form" id="depositFormId">
            <Card.Body>
              <Form.Row>
